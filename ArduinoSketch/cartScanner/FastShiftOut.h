/*
 * FastShiftOut 0.4.3 by Rob Tillaart.
 * Copyright (c) 2013-2026 Rob Tillaart
 * Distributed under the MIT License; see FastShiftOut-LICENSE.txt.
...
//  Use the library's unrolled AVR implementation for the address-register hot path.
